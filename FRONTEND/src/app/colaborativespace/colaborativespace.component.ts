...
@Component({
  selector: 'app-colaborativespace',
  templateUrl: './colaborativespace.component.html',
  styleUrls: ['./colaborativespace.component.css']
})
export class ColaborativespaceComponent {
  projectId!: string;
